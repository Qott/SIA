...
$catalogue = new MessageCatalogue('fr-FR', array (
  ...
  array (
    ...
    'The email "%mail%" is already used, please choose another one or sign in' => 'L\'adresse "%mail%" est déjà utilisée, veuillez en choisir une autre ou vous connecter',
...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'undefined' => 'indéfini',
    'Your online store needs to have a proper carrier registered in PrestaShop as soon as you start shipping your products. This means sending yours parcels using your local postal service, or having a contract with a private carrier which in turn will ship your parcels to your customers. In order to have PrestaShop suggest the most adequate carrier to your customers during their order checkout process, you need to register all the carriers with which you have chosen to work.' => 'Pour expédier vos produits, enregistrez un transporteur dans votre PrestaShop. Ainsi, vous pouvez gérer l\'expédition de vos colis à vos clients par un service de Poste local ou un transporteur privé. Pour que PrestaShop puisse suggérer le transporteur le plus adéquat à vos clients lors de leur procédure d\'achat, vous devez enregistrer tous les transporteurs avec lesquels vous avez choisi de travailler.',
    'PrestaShop comes with a number of carrier modules that you can activate. You can also buy carrier modules on the PrestaShop Addons marketplace. Recommended modules are listed below: install the module that matches your carrier, and configure it!' => 'PrestaShop est fourni avec un certain nombre de modules de transporteurs que vous pouvez activer. Vous pouvez également acheter des modules de transporteurs sur la Marketplace Addons. Des modules recommandés sont listés ci-dessous : installez le module qui correspond à votre transporteur, et configurez-le !',
    'If there is no existing module for your carrier, then you can register that carrier by hand using the information that it can provide you: shipping rates, regional zones, size and weight limits, etc. Click on the "Add new carrier" button below to open the Carrier Wizard, which will help you register a new carrier in a few steps.' => 'S\'il n\'existe pas de module pour votre transporteur, alors vous pouvez l\'enregistrer vous-même. Il vous suffit de compléter les informations qu\'il vous aura transmises : frais d\'expédition, zones régionales, limites en tailles et en poids, etc. Pour enregistrer un nouveau transporteur, cliquez sur le bouton "Créer un transporteur" ci-dessus. Parcourez les quatre étapes afin de configurer votre nouveau transporteur.',
  ...
  array (
    ...
    '%language% could not be loaded' => 'La langue %language% n\'a pas pu être chargée.',
    ...
    'Please select a module!' => 'Veuillez sélectionner un module !',
  ...
  array (
    ...
    'Error: parameter "to" is corrupted' => 'Erreur : le paramètre « to » est corrompu',
    'Error: parameter "bcc" is corrupted' => 'Erreur : le paramètre « cci » est corrompu',
    'Error: invalid e-mail template' => 'Erreur : template e-mail non valable',
    'Error: invalid e-mail subject' => 'Erreur : sujet d\'e-mail non valable',
    'Error: invalid e-mail address' => 'Erreur : adresse e-mail non valable',
    'Error: invalid SMTP server or SMTP port' => 'Erreur : Serveur ou port SMTP invalides',
    ...
    'When saving the query, only the "SELECT" SQL statement is allowed.' => 'Lorsque vous enregistrez la requête, seule la directive "SELECT" est autorisée.',
  ...
  array (
    ...
    'Tips and Updates module' => 'Module de Conseils et Mises à jour',
    'Thanks to this module, connect to your Addons account from the dashboard of your back-office' => 'Grâce à ce module, connectez vous à votre compte Addons directement depuis le tableau de bord de votre back-office',
    'Are you sure you want to uninstall this module?' => 'Êtes-vous sûr de vouloir désinstaller ce module ?',
    'There was an error during the installation. Please contact us through Addons website' => 'Une erreur s\'est produite pendant l\'installation. Veuillez nous contacter via le site Addons',
    'There was an error during the desinstallation. Please contact us through Addons website' => 'Une erreur s\'est produite pendant la désinstallation. Veuillez nous contacter via le site Addons',
    ...
    'PrestaShop Security' => 'PrestaShop Security',
    'Protect your store from fraudulent payments' => 'Protégez votre boutique des paiements frauduleux',
    '-- Please choose your main activity --' => '-- Veuillez choisir votre activité principale --',
    'Adult' => 'Adulte',
    'Animals and Pets' => 'Animaux',
    'Art and Culture' => 'Arts et culture',
    ...
    'Credit card multiple' => 'Paiement en plusieurs fois, par carte bancaire',
    'Prepaid account (MoneyBookers, PayPal...)' => 'Compte prépayé (MoneyBookers, PayPal, etc.)',
    'Please accept the terms of service.' => 'Merci d\'accepter les conditions générales de vente.',
    'PrestaShop Security configuration' => 'Configuration de PrestaShop Security',
    'My shop does not have a PrestaShop Security account yet' => 'Mon magasin n\'a pas encore de compte sur Prestashop Security',
    'I already have an account' => 'J\'ai déjà un compte',
    'Your email' => 'Votre adresse email',
    'Shop Url' => 'URL de la boutique',
    'I agree with the terms of PrestaShop Security service and I adhere to them unconditionally.' => 'Je suis d\'accord avec les conditions de service PrestaShop Security et y adhère sans condition.',
    'Create account' => 'Créez votre compte',
    'Shop ID' => 'ID de la boutique',
    'Shop KEY' => 'Clé de la boutique',
    'Shop activity' => 'Activité de la boutique',
    'Carriers' => 'Transporteurs',
    'Carrier' => 'Transporteur',
    'Carrier Type' => 'Type de transporteur',
    'Choose a carrier type...' => 'Choisissez un type de transporteur...',
    'Payments' => 'Paiments',
    'Payment Module' => 'Module de paiement',
    'Payment Type' => 'Type de paiement',
    'Choose a payment type...' => 'Choisissez un type de paiement ...',
    'Email is invalid' => 'L\'adresse email n\'est pas valide',
    'Shop URL is invalid' => 'L\'URL de la boutique n\'est pas valide',
    'Impossible to create a new account, please report this bug on http://forge.prestashop.com/' => 'Impossible de créer un nouveau compte, veuillez signalez ce bug sur http://forge.prestashop.com/',
    'This order has not been sent to PrestaShop Security.' => 'Cette commande n\'a pas été envoyé à PrestaShop Security.',
    'Scoring:' => 'Scoring :',
    'Unknown' => 'Inconnu',
    'Report this order as a fraud to PrestaShop' => 'Signaler cette commande comme une fraude à PrestaShop',
    'Pick up in-store' => 'Retrait en magasin',
    'Withdrawal point' => 'Point de retrait',
    'Slow shipping more than 3 days' => 'Livraison lente de plus de 3 jours',
    ...
    'TIPS & UPDATES' => 'CONSEILS & MISES À JOUR',
    'Connect to your account right now to enjoy updates (security and features) on all of your modules.' => 'Connectez vous à votre compte dès à présent afin de profiter des mises à jour (fonctionnelles et de sécurité) sur l\'ensemble de vos modules.',
    'Once you are connected, you will also enjoy weekly tips directly from your back office.' => 'Une fois connecté, vous pourrez également profiter des conseils de la semaine directement depuis votre back-office.',
    'CONNECT TO PRESTASHOP MARKETPLACE' => 'CONNECTEZ VOUS A LA MARKETPLACE PRESTASHOP',
    'Connect to PrestaShop marketplace' => 'Connectez vous à la marketplace Prestashop',
    'Link your shop to your Addons account to automatically receive important updates for the modules you purchased. Don\'t have an account yet ?' => 'Reliez votre boutique à votre compte Addons pour recevoir automatiquement les mises à jour importantes des modules que vous avez achetés. Vous n\'avez pas encore de compte ?',
    'Sign up now' => 'S\'inscrire maintenant',
    'Email address' => 'Adresse e-mail',
    'Remember me' => 'Se souvenir de moi',
    'LET\'S GO !' => 'C\'EST PARTI !',
    'Forgot your password?' => 'Mot de passe oublié ?',
    'Tip of the moment' => 'Conseil du moment',
    'See the entire selection' => 'Voir la sélection complète',
    'Practical links' => 'Liens pratiques',
    'Modules to' => 'Modules pour',
    'increase your traffic' => 'augmenter votre trafic',
    'boost your conversions' => 'booster vos conversions',
    'increase your clients\' average cart' => 'augmenter le panier moyen de vos clients',
    'Selection of modules recommended for' => 'Sélection des modules recommandés pour',
    'your business sector' => 'votre secteur d\'activité',
    'Password' => 'Mot de passe',
    'Your password has been successfully changed.' => 'Votre mot de passe a été modifié avec succès.',
    'Your Sitemaps were successfully created. Please do not forget to setup the URL' => 'Vos fichiers Sitemaps ont été créés avec succès. N\'oubliez pas de configurer l\'URL',
    'in your Google Webmaster account.' => 'dans votre interface Google Webmaster.',
    'Your Sitemaps' => 'Vos fichiers sitemap',
    ...
    'This URL is the master Sitemaps file. It refers to the following sub-sitemap files:' => 'Cette URL correspond au fichier sitemap maître et fait référence aux fichiers suivants :',
    ...
    'Several Sitemaps files will be generated depending on how your server is configured and on the number of activated products in your catalog.' => 'Plusieurs fichiers sitemap seront générés en fonction de la configuration de votre serveur et du nombre de produits activés dans votre catalogue.',
    ...
    'check all' => 'Tout cocher',
    'Indicate the pages that you do not want to include in your Sitemaps file:' => 'Indiquez les pages que vous voulez exclure de votre sitemap :',
    'Generate Sitemap' => 'Créer votre sitemap',
    'This can take several minutes' => 'Cela peut prendre plusieurs minutes',
    'You have two ways to generate Sitemap:' => 'Vous pouvez générer votre sitemap de deux manières :',
    ...
    'It will automatically generate your XML Sitemaps.' => 'Cela générera automatiquement vos fichiers sitemap XML.',
    'uncheck all' => 'Tout décocher',
    'Error!' => 'Erreur !',
    'Warning!' => 'Attention !',
    'Success!' => 'Réussite !',
  ...
  array (
    ...
    'To which category the page should redirect?' => 'Vers quel catégorie la page doit-elle rediriger ?',
    ...
    'edit' => 'Modifier',
    'If a carrier has a tax, it will be added to the shipping fees.' => 'Si un transporteur a une taxe, elle sera ajoutée aux frais de livraison - ne s\'applique pas aux transporteurs gratuits.',
  ...
  array (
    ...
    'Unable to check files' => 'Impossible de vérifier les fichiers',
    ...
    'Skip downloading and unzipping steps, upgrade process will now remove sample data.' => 'Étapes téléchargement et désarchivage ignorées, le processus de mise à jour va maintenant supprimer les données de démonstration.',
    'Shop deactivated. Removing sample files...' => 'Boutique désactivée. Suppression de fichiers d\'exemple...',
    'Skip downloading step, upgrade process will now unzip the local archive.' => 'Étape de téléchargement ignorée, le processus de mise à jour va maintenant désarchiver l\'archive locale.',
    ...
    'This is not a valid archive for version %s.' => 'Il n\'y a pas d\'archive valide pour la version %s.',
    'Extraction directory is not writable.' => 'Impossible d\'écrire dans le dossier d\'extraction.',
    ...
    'Unable to list files to upgrade' => 'Impossible de lister les fichiers à mettre à jour',
    ...
    'Nothing has been extracted. It seems the unzip step has been skipped.' => 'Rien n\'a été extrait. Il semble que l\'étape "décompression" ait été sautée.',
    '%s modules will be upgraded.' => '%s modules seront mis à jour.',
    'upgradeModule step has not ended correctly.' => 'l\'étape upgradeModule (mise à jour des modules) ne s\'est pas terminée correctement.',
    ...
    '/install/upgrade/php directory is missing in archive or directory.' => 'Le dossier /install/upgrade/php est manquant dans l\'archive ou le répertoire.',
    'The app/config/parameters.php file was not found.' => 'Le fichier app/config/parameters.php n\'a pas été trouvé.',
    'The app/config/parameters.yml file was not found.' => 'Le fichier app/config/parameters.yml n\'a pas été trouvé.',
    ...
    'Error while loading sql SQL file %s.' => 'Erreur lors du chargement du fichier de mise à jour SQL %s.',
    '[DROP] SQL %s table has been dropped.' => '[SUPPRESSION] La table SQL %s a été supprimée.',
    'An error happened during the database upgrade.' => 'Une erreur est survenue pendant la mise à jour de la base de données.',
    ...
    'File %filename% (size: %filesize%) added to archive. %filescount% files left.' => 'Le fichier %filename% (taille : %filesize%) a été ajouté à l\'archive. %filescount% fichiers restants.',
    'File %filename% (size: %filesize%) added to archive.' => 'Le fichier %filename% (taille : %filesize%) a été ajouté à l\'archive. ',
    ...
    'All files saved. Now backing up database.' => 'Tous les fichiers sont enregistrés. Sauvegarde de la base de données.',
    '%itemname% items removed. %itemscount% items left.' => 'L\'élément %itemname% a été supprimé. %itemscount% restants.',
    ...
    '[WARNING] Property %s is missing' => '[ATTENTION] La propriété %s est manquante',
    'Action %s skipped' => 'L\'action %s a été ignorée',
    'Action "%s" not found' => 'Action "%s" non trouvée',
    'Too long!' => 'Trop long !',
    'Fields are different!' => 'Les champs sont différents !',
    'This email address is wrong!' => 'Cette adresse est invalide !',
    'Impossible to send the email!' => 'Impossible d\'envoyer l\'email !',
    ...
    'Data integrity is not valided. Hack attempt?' => 'L\'intégrité des données n\'est pas validée.',
    ...
    'An error occurred while sending email, please verify your parameters.' => 'Une erreur est survenue lors de l\'envoi de l\'email, merci de vérifier vos paramètres.',
    ...
    'The 1-click upgrade module is up-to-date (your current version is v%s)' => 'Le module de mise à jour en 1 clic est à jour (votre version est v%s)',
    'Download' => 'Téléchargement',
    'Your store\'s root directory is writable (with appropriate CHMOD permissions)' => 'La racine de votre boutique doit être accessible en écriture (permissions CHMOD appropriées)',
    ...
    'Click here to put your shop under maintenance' => 'Cliquez ici pour mettre votre shop en maintenance',
    ...
    'Channel:' => 'Canal :',
    'This option regroup all stable versions.' => 'Cette option vous fera profiter de toutes les versions stables.',
    'Link:' => 'Lien :',
    ...
    'Save in the following directory the archive file of the version you want to upgrade to: %s' => 'Enregistrez dans le répertoire suivant l\'archive de la version vers laquelle vous souhaitez migrer : %s',
    'Click "Save" once the archive is there.' => 'Cliquez sur "Enregistrer" dès que l\'archive y est.',
    ...
    'You use Smarty 3' => 'Vous utilisez Smarty 3',
    'Smarty 2 is deprecated in 1.4 and was removed in 1.5. You may need to upgrade your current theme or use a new one.' => 'Smarty 2 est déprécié dans la version 1.4 et a été supprimé en 1.5. Vous pouvez choisir de mettre à jour votre thème actuel ou utiliser un nouveau thème.',
    ...
    'Last datetime check: %s ' => 'Dernière vérification : %s  ',
    'This functionality has been disabled.' => 'Cette fonctionnalité a été désactivé.',
    ...
    'Welcome!' => 'Bienvenue !',
    'With the PrestaShop 1-Click Upgrade module, upgrading your store to the latest version available has never been easier!' => 'Avec le module de mise à jour en un clic, mettre à jour votre boutique vers la version de PrestaShop la plus récente n\'a jamais été aussi facile !',
    'Please always perform a full manual backup of your files and database before starting any upgrade.' => 'Veuillez s\'il vous plaît toujours faire une sauvegarde manuelle complète de vos fichiers et de votre base de données avant de commencer une mise à jour.',
    'Double-check the integrity of your backup and that you can easily manually roll-back if necessary.' => 'Vérifiez bien l\'intégrité de votre sauvegarde des données et vérifiez que vous pouvez facilement restaurer votre boutique manuellement si nécessaire.',
    'If you do not know how to proceed, ask your hosting provider.' => 'Si vous ne savez pas comment procéder, demandez à votre hébergeur.',
    'Backup Options' => 'Options de sauvegarde',
    ...
    'Do you want to restore %backupname%?' => 'Voulez-vous restaurer les données de %backupname% ?',
    'Operation canceled. An error happened.' => 'Opération annulée. Une erreur est survenue.',
    '[TECHNICAL ERROR] ajax-upgradetab.php is missing. please reinstall the module' => '[ERREUR TECHNIQUE] ajax-upgradetab.php est manquant. Veuillez réinstaller ou réinitialiser le module.',
    ...
    'Your server cannot download the file. Please upload it to your FTP server, and put it in your /[admin]/autoupgrade directory.' => 'Votre serveur ne peut pas télécharger ce fichier. Veuillez le charger sur votre serveur FTP et le placer dans votre dossier /[admin]/autoupgrade.',
    'Theses files will be deleted' => 'Ces fichiers seront supprimés',
    'Theses files will be modified' => 'Ces fichiers seront modifiés',
    ...
    'Required field' => 'Champ requis',
    'Selection successfully deleted' => 'Sélection supprimée avec succès',
    'The new version check has been completed successfully' => 'Nouvelle version vérifiée avec succès',
    'Message sent to the customer' => 'Message envoyé au client',
    'Language successfully copied' => 'Langue copiée avec succès',
    'Refund Successful' => 'Remboursement effectué',
    'Images successfully moved' => 'Images déplacées avec succès',
    'In order to use a new theme, please follow these steps:' => 'Afin d\'utiliser un nouveau thème, merci de suivre les étapes suivantes',
    'Import your theme using this module:' => 'Importer votre thème en utilisant ce module',
    'Theme installer' => 'Installeur de thème',
    'When your theme is imported, please select the theme in this page' => 'Quand votre thème est importé, merci de sélectionner celui-ci sur cette page',
    'Add my IP' => 'Ajouter mon IP',
    'If you change the theme, the parameters.php file must be writable (CHMOD 755 / 777)' => 'Si vous changez de thème, le fichier parameters.php doit être accessible en écriture (CHMOD 755 ou 777)',
    'Back' => 'Précédent',
    'You do not have permission to add here' => 'Vous n\'avez pas les droits suffisants pour l\'ajout',
    'Set required fields for this section' => 'Définir les champs requis pour cette section',
    'Required Fields' => 'Champs requis',
    'Select the fields you would like to be required for this section.' => 'Sélectionnez les champs que vous voulez rendre obligatoires pour cette section.',
    'Field Name' => 'Nom du champ',
    'The field named %s is required.' => 'Le champ nommé %s est requis.',
    'The field named %fieldname% is required at least in the %languagename% language.' => 'Le champ %fieldname% est requis au moins dans la langue %languagename%.',
    'The field named %fieldname% is too long (%charsnumber% chars max).' => 'Le champ %fieldname% est trop long (%charsnumber% caractères max).',
    'Your entry in field %fieldname% (language %languagename%) exceeds max length %charsnumber% chars (incl. HTML tags).' => 'Le champs %fieldname% (langue %languagename%) dépasse la longueur maximale autorisée (%charsnumber% caractères, y compris les balises HTML).',
    'An error occurred during image deletion (cannot load object).' => 'une erreur s\'est produite pendant la suppression de l\'image',
    'You need at least one object.' => 'vous devez garder au moins un objet',
    'You cannot delete all of the items.' => 'Vous ne pouvez pas tous les supprimer.',
    'An error occurred during deletion.' => 'une erreur s\'est produite pendant la suppression',
    '(cannot load object)' => '(impossible de charger l\'objet)',
    'You do not have permission to add here.' => 'Vous n\'avez pas les droits suffisants pour l\'ajout.',
    'Error in updating required fields' => 'Erreur dans la mise à jour les champs requis ',
    'Can not add configuration %configurationkey% for lang %isocode%' => 'Impossible d\'ajouter la configuration %configurationkey% pour la langue %isocode%',
    'Can not add configuration %configurationkey%' => 'Impossible d\'ajouter la configuration %configurationkey%',
    '%title% : Incorrect value' => '%title% : valeur incorrecte',
    'An error occurred while uploading favicon: %iconname% to %destination%' => 'Une erreur s\'est produite lors de la copie de la favicon : %iconname% vers %destination%.',
    'errors' => 'erreurs',
    'There are %count% warnings' => 'Il y a %count% avertissements.',
    'There is %count% warning' => 'Il y a %count% avertissement.',
    'Click here to see more' => 'Cliquez ici pour en savoir plus',
    'Hide warning' => 'Masquer l\'avertissement',
    'Delete item #' => 'Supprimer l\'élément n°',
    'Object cannot be loaded (not found)' => 'objet impossible à charger (introuvable)',
    'Object cannot be loaded (identifier missing or invalid)' => 'objet impossible à charger (identifiant manquant ou invalide)',
    'Your are currently connected with the following domain name:' => 'Vous êtes actuellement connecté avec le nom de domaine suivant :',
    'This one is different from the main shop domain name set in "Preferences > SEO & URLs":' => 'Celui-ci est différent du nom de domaine de la boutique principale présent dans l\'onglet "Préférences > SEO et URLs" :',
    'Click here if you want to modify the main shop domain name' => 'Cliquez ici si vous souhaitez modifier le nom de domaine de la boutique principale',
    'Field %name% is required' => 'Le champ %name% est requis.',
    'Field %name% is invalid' => 'Le champ %name% n\'est pas valide.',
  ),
  ...
  array (
    ...
    'The image could not be found. ' => 'L\'image ne peut être trouvée. ',
  ...
  array (
    ...
    'Editing this product line will remove the reduction and base price.' => 'Modifier cette ligne produit supprimera la réduction et le prix d\'origine.',
