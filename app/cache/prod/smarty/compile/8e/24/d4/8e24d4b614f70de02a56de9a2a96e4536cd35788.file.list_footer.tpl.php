<?php /* Smarty version Smarty-3.1.19, created on 2018-03-14 23:36:39
         compiled from "/home/betty/www/prestashop/admin162edhmah/themes/default/template/helpers/list/list_footer.tpl" */ ?>
<?php /*%%SmartyHeaderCode:7088291995aa9a3f7bca9b3-69757821%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8e24d4b614f70de02a56de9a2a96e4536cd35788' => 
    array (
      0 => '/home/betty/www/prestashop/admin162edhmah/themes/default/template/helpers/list/list_footer.tpl',
      1 => 1519649750,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '7088291995aa9a3f7bca9b3-69757821',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5aa9a3f7c48914_63057345',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5aa9a3f7c48914_63057345')) {function content_5aa9a3f7c48914_63057345($_smarty_tpl) {?>
</table>
</div>
<div class="row">
	<div class="col-lg-6">
...
"<?php }?>>
				<?php echo smartyTranslate(array('s'=>'Bulk actions','d'=>'Admin.Global'),$_smarty_tpl);?>
...
<?php }?>" class="btn btn-default<?php if (isset($_smarty_tpl->tpl_vars['back_button']->value['target'])&&$_smarty_tpl->tpl_vars['back_button']->value['target']) {?> _blank<?php }?>"<?php if (isset($_smarty_tpl->tpl_vars['back_button']->value['href'])) {?> href="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['back_button']->value['href'],'html','UTF-8');?>
...
<?php if (!$_smarty_tpl->tpl_vars['simple_header']->value) {?>
		<input type="hidden" name="token" value="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_smarty_tpl->tpl_vars['token']->value,'html','UTF-8');?>
" />
	</div>
<?php } else { ?>
	</div>
