<?php /* Smarty version Smarty-3.1.19, created on 2018-03-14 23:31:45
         compiled from "/home/betty/www/prestashop/admin162edhmah/themes/default/template/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19567788255aa9a2d1575cf6-20781621%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9674ecb6152fcc4243f829e7439d86238f11f1f2' => 
    array (
      0 => '/home/betty/www/prestashop/admin162edhmah/themes/default/template/header.tpl',
      1 => 1519649750,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '19567788255aa9a2d1575cf6-20781621',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5aa9a2d1632695_49658068',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5aa9a2d1632695_49658068')) {function content_5aa9a2d1632695_49658068($_smarty_tpl) {?>
<!DOCTYPE html>
...
<?php if (isset($_smarty_tpl->tpl_vars['shop_context']->value)) {?>
	<?php if ($_smarty_tpl->tpl_vars['shop_context']->value==Shop::CONTEXT_ALL) {?>
		var youEditFieldFor = '<?php echo smartyTranslate(array('s'=>'This field will be modified for all your shops.','js'=>1,'d'=>'Admin.Notifications.Info'),$_smarty_tpl);?>
';
	<?php } elseif ($_smarty_tpl->tpl_vars['shop_context']->value==Shop::CONTEXT_GROUP) {?>
		var youEditFieldFor = '<?php echo smartyTranslate(array('s'=>'This field will be modified for all shops in this shop group:','js'=>1,'d'=>'Admin.Notifications.Info'),$_smarty_tpl);?>
 <b><?php echo addcslashes($_smarty_tpl->tpl_vars['shop_name']->value,'\'');?>
</b>';
	<?php } else { ?>
		var youEditFieldFor = '<?php echo smartyTranslate(array('s'=>'This field will be modified for this shop:','js'=>1,'d'=>'Admin.Notifications.Info'),$_smarty_tpl);?>
 <b><?php echo addcslashes($_smarty_tpl->tpl_vars['shop_name']->value,'\'');?>
</b>';
	<?php }?>
<?php } else { ?>
		var youEditFieldFor = '';
<?php }?>
		var new_order_msg = '<?php echo smartyTranslate(array('s'=>'A new order has been placed on your shop.','js'=>1,'d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
';
		var order_number_msg = '<?php echo smartyTranslate(array('s'=>'Order number:','js'=>1,'d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
 ';
		var total_msg = '<?php echo smartyTranslate(array('s'=>'Total','js'=>1,'d'=>'Admin.Global'),$_smarty_tpl);?>
 ';
		var from_msg = '<?php echo smartyTranslate(array('s'=>'From:','js'=>1,'d'=>'Admin.Global'),$_smarty_tpl);?>
 ';
		var see_order_msg = '<?php echo smartyTranslate(array('s'=>'View this order','js'=>1,'d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
';
		var new_customer_msg = '<?php echo smartyTranslate(array('s'=>'A new customer registered on your shop.','js'=>1,'d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
';
		var customer_name_msg = '<?php echo smartyTranslate(array('s'=>'registered','js'=>1,'d'=>'Admin.Navigation.Notification'),$_smarty_tpl);?>
 ';
		var new_msg = '<?php echo smartyTranslate(array('s'=>'A new message was posted on your shop.','js'=>1,'d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
';
		var see_msg = '<?php echo smartyTranslate(array('s'=>'Read this message','js'=>1,'d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
';
...
';
		var choose_language_translate = '<?php echo smartyTranslate(array('s'=>'Choose language:','js'=>1,'d'=>'Admin.Actions'),$_smarty_tpl);?>
';
...
<?php }?>';
		var update_success_msg = '<?php echo smartyTranslate(array('s'=>'Successful update.','js'=>1,'d'=>'Admin.Notifications.Success'),$_smarty_tpl);?>
';
		var errorLogin = '<?php echo smartyTranslate(array('s'=>'PrestaShop was unable to log in to Addons. Please check your credentials and your Internet connection.','js'=>1,'d'=>'Admin.Notifications.Warning'),$_smarty_tpl);?>
';
		var search_product_msg = '<?php echo smartyTranslate(array('s'=>'Search for a product','js'=>1,'d'=>'Admin.Orderscustomers.Feature'),$_smarty_tpl);?>
';
	</script>
<?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['lang_is_rtl']->value) {?> lang-rtl<?php }?> ps_back-office<?php if ($_smarty_tpl->tpl_vars['employee']->value->bo_menu) {?> page-sidebar<?php if ($_smarty_tpl->tpl_vars['collapse_menu']->value) {?> page-sidebar-closed<?php }?><?php } else { ?> page-topbar<?php }?> <?php echo strtolower($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_GET['controller']));?>
">
...
">
											...
											<?php echo smartyTranslate(array('s'=>'Remove from QuickAccess','d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
                  ...
                  <li>
                    <a href="javascript:void(0);" class="ajax-quick-link" data-method="add">
                      ...
                      <?php echo smartyTranslate(array('s'=>'Add current page to QuickAccess','d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
...
">
                    <i class="icon-cog"></i>
                    <?php echo smartyTranslate(array('s'=>'Manage quick accesses','d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
					...
					<script>
						$(function() {
							$('.ajax-quick-link').on('click', function(e){
								...
								if(method == 'add')
									var name = prompt('<?php echo smartyTranslate(array('s'=>'Please name this shortcut:','js'=>1,'d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
...
" + "&ajax=1" + "&method=" + method + ( $(this).data('quicklink-id') ? "&id_quick_access=" + $(this).data('quicklink-id') : ""),
										data: {
											"url": "<?php echo $_smarty_tpl->tpl_vars['link']->value->getQuickLink($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->smartyEscape($_SERVER['REQUEST_URI'],'javascript'));?>
",
											"name": name,
...
">
                        <a class="nav-link" data-toggle="tab" data-type="order" href="#orders-notifications" role="tab" id="orders-tab"><?php echo smartyTranslate(array('s'=>'Latest orders','d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
<span id="orders_notif_value"></span></a>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['show_new_customers']->value) {?>
                      <li class="nav-item <?php echo $_smarty_tpl->tpl_vars['active']->value;?>
">
                        <a class="nav-link" data-toggle="tab" data-type="customer" href="#customers-notifications" role="tab" id="customers-tab"><?php echo smartyTranslate(array('s'=>'New customers','d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
<span id="customers_notif_value"></span></a>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['show_new_messages']->value) {?>
                      <li class="nav-item <?php echo $_smarty_tpl->tpl_vars['active']->value;?>
">
                        <a class="nav-link" data-toggle="tab" data-type="customer_message" href="#messages-notifications" role="tab" id="messages-tab"><?php echo smartyTranslate(array('s'=>'Messages','d'=>'Admin.Global'),$_smarty_tpl);?>
              ...
              <?php if (isset($_smarty_tpl->tpl_vars['debug_mode']->value)&&$_smarty_tpl->tpl_vars['debug_mode']->value==true) {?>
                <span class="shop-state hidden-xs" id="debug-mode">
                  ...
                  <span class="label-tooltip" data-toggle="tooltip" data-placement="bottom" data-html="true"
                    title="<p class='text-left text-nowrap'><strong><?php echo smartyTranslate(array('s'=>'Your shop is in debug mode.','d'=>'Admin.Navigation.Notification'),$_smarty_tpl);?>
</strong></p><p class='text-left'><?php echo smartyTranslate(array('s'=>'All the PHP errors and messages are displayed. When you no longer need it, [1]turn off[/1] this mode.','html'=>true,'sprintf'=>array('[1]'=>'<strong>','[/1]'=>'</strong>'),'d'=>'Admin.Navigation.Notification'),$_smarty_tpl);?>
</p>"><?php echo smartyTranslate(array('s'=>'Debug mode','d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
</span>
                </span>
              <?php }?>
              <?php if (isset($_smarty_tpl->tpl_vars['maintenance_mode']->value)&&$_smarty_tpl->tpl_vars['maintenance_mode']->value==true) {?>
                <span class="shop-state" id="maintenance-mode">
                  <i class="material-icons">build</i>
                    ...
                    title="<p class='text-left text-nowrap'><strong><?php echo smartyTranslate(array('s'=>'Your shop is in maintenance.','d'=>'Admin.Navigation.Notification'),$_smarty_tpl);?>
</strong></p><p class='text-left'><?php echo smartyTranslate(array('s'=>'Your visitors and customers cannot access your shop while in maintenance mode.%s To manage the maintenance settings, go to Shop Parameters > Maintenance tab.','sprintf'=>array('<br />'),'d'=>'Admin.Navigation.Notification'),$_smarty_tpl);?>
...
"><?php echo smartyTranslate(array('s'=>'Maintenance mode','d'=>'Admin.Navigation.Header'),$_smarty_tpl);?>
...
<?php if ($_smarty_tpl->tpl_vars['install_dir_exists']->value) {?>
			<div class="alert alert-warning">
				<?php echo smartyTranslate(array('s'=>'For security reasons, you must also delete the /install folder.','d'=>'Admin.Login.Notification'),$_smarty_tpl);?>
